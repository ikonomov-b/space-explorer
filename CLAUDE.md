...
[`game-inspector`](.claude/agents/game-inspector.md) asks the question no other document asks: for the time a destination costs a player, what does it give them to do. It holds the 15-to-30-minute expedition loop, the 60-second starter destination, and the useful-playable-content-per-second measurement of [decision 0004](docs/decisions/0004-preparation-is-real-generation-time.md), and it refuses padding, wall-clock value, and free value on principle. It proposes measurements, not numbers.
