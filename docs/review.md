...
The nineteen findings of the documentation stage were cleared on 2026-09-07; the status table links each to its decision record or to the document it changed. An implementation review the same day, after the first two M0a steps landed, raised [findings 20 to 27](#findings-raised-by-the-implementation-review), of which all eight are cleared. A scan of the [development plan](development-plan.md) for gaps and misorders, also 2026-09-07, raised [findings 28 and 29](#findings-raised-by-the-development-plan-scan), both cleared. A review of surface-view realism raised [finding 30](#30-surface-sky-is-decorative-rather-than-astronomically-derived), cleared by decision 0032. An inspection of the primitive storage and handling plan against the design, also 2026-09-07, raised [findings 31 to 36](#findings-raised-by-the-primitive-storage-inspection), cleared the same day by decisions 0033 to 0035, 0039, and 0040. A check of the same structures against the realistic planetary model of decision 0032 raised [findings 37 to 41](#findings-raised-by-the-planetary-model-sufficiency-check), cleared by decisions 0036 to 0038 and 0041. Checks performed for this review, repeatable with `dotnet run tools/docs.cs -- --check` (links, anchors, decision numbering, the generated decision table; run in continuous integration) and `-- --external` (cited URLs): every internal link and anchor in the documents resolves; all 54 cited external URLs respond, except Epic's Unreal Engine licence page, which answers automated requests with HTTP 403 and must be opened in a browser; the worked valuation and byte-size examples are arithmetically correct. The scaffold of [decision 0016](decisions/0016-platform-confirmed-and-toolchain-pinned.md) builds and its tests pass on both operating systems; only the random foundation and the canonical encoding are tested against code, and the remaining design statements are not. Terms used below are defined in the [glossary](glossary.md). The owner's generation note of 2026-09-08 raised [finding 42](#42-the-generation-note-diverges-from-the-concept-plan-and-accepted-decisions), cleared the same day by decisions 0043 to 0046. Implementing the composition generator, also 2026-09-08, raised [findings 43 to 45](#findings-raised-by-the-composition-generator), cleared by [decision 0048](decisions/0048-composition-grammar-version-1-graph-records-and-graph-publication.md). Running the first solar-system iteration the same day raised [findings 46 and 47](#findings-raised-by-the-first-solar-system-iteration); 46 is cleared by [decision 0049](decisions/0049-suit-profile-and-system-description-version-1-and-derivation-rules-as-named-implementations.md) and 47 is the first finding this review carries open. The owner's note the same day that every randomization level is eventually judged by a graphic representation raised [finding 48](#48-every-randomization-level-is-to-be-judged-graphically-and-nothing-says-which-view-in-what-order-or-against-what-vector), also open. Rendering iteration 3's twenty-four systems as pictures for that reading, on 2026-09-10, raised [finding 49](#49-the-review-views-panel-and-the-system-it-describes-compete-for-one-screen), cleared the same day by [decision 0054](decisions/0054-the-review-panel-carries-the-summary-while-the-system-is-framed.md). An audit of the whole solar-system chain against the primitive-completeness invariant, asked for on 2026-09-10 after the levers, the review view and the body appearance landed, raised [findings 50 to 54](#findings-raised-by-the-solar-system-storage-audit); 51 is cleared by [decision 0059](decisions/0059-region-limits-are-a-pinned-record.md) and 50 by [decision 0060](decisions/0060-registry-revision-4-units-defaults-and-validation-limits.md), built as registry revision 4, which also builds the registry half of 53; 52, 53 and 54 are open. A storage assessment the same day, reading the structure against what a planet surface will ask of it, raised [finding 55](#55-uniqueness-is-unguarded-above-the-artifact), open. Checking the owner's six statements of 2026-09-12 against the accepted records and the build, before the next surface rung, raised [findings 56 and 57](#findings-raised-before-the-fourth-surface-rung); 56 is cleared the same day by [decision 0071](decisions/0071-the-explorable-planet-is-the-subject-the-far-field-before-features-and-a-two-window-inspection.md) and 57 is open.
...
| 38 | [Planet-level fields have no spherical form and the flat region bounds the explorable body radius](#38-planet-level-fields-have-no-spherical-form-and-the-flat-region-bounds-the-explorable-body-radius) | Foundational | Cleared, [decision 0041](decisions/0041-planet-fields-tangent-regions-minimum-radius-and-far-field.md) |
| 39 | [Nothing is defined beyond the region edge](#39-nothing-is-defined-beyond-the-region-edge) | Gap | Cleared, [decision 0041](decisions/0041-planet-fields-tangent-regions-minimum-radius-and-far-field.md) |
...
| 42 | [The generation note diverges from the concept, plan, and accepted decisions](#42-the-generation-note-diverges-from-the-concept-plan-and-accepted-decisions) | Gap | Cleared, decisions [0043](decisions/0043-destination-controls-distance-tier-and-seed-lever.md) to [0046](decisions/0046-artifact-families-human-height-cap-cargo-by-mass-and-material-rarity.md) |
| 43 | [Connector tags do not say which side of an edge provides them](#43-connector-tags-do-not-say-which-side-of-an-edge-provides-them) | Foundational | Cleared, [decision 0048](decisions/0048-composition-grammar-version-1-graph-records-and-graph-publication.md) |
...
| 47 | [Nothing holds independently drawn parameters of one body physically consistent](#47-nothing-holds-independently-drawn-parameters-of-one-body-physically-consistent) | Foundational | Cleared, [decision 0050](decisions/0050-registry-revision-2-grammar-version-2-and-versioned-record-growth.md) |
| 48 | [Every randomization level is to be judged graphically, and nothing says which view, in what order, or against what vector](#48-every-randomization-level-is-to-be-judged-graphically-and-nothing-says-which-view-in-what-order-or-against-what-vector) | Gap | **Open for the artifact level.** Partly answered, as the body records: [decision 0052](decisions/0052-the-two-levers-compose-a-destination-and-a-review-view-shows-it.md) makes the system view a review harness and not a core-release feature, so the close-views clause of [decision 0045](decisions/0045-close-views-only-in-the-surface-sky-and-a-derived-system-description.md) stands, and [decision 0055](decisions/0055-definition-level-tags-and-tagged-references.md) supplies the third part's prerequisite, a registry revision that admits a surface material to a body. [Decision 0061](decisions/0061-surface-iterations-by-an-escalating-ladder-registry-revision-5-and-grammar-version-6.md), accepted on 2026-09-11, settles the remaining three parts for the surface level — the order of the levels, the view, and the vector — and [decision 0062](decisions/0062-the-surface-harness-walks-in-an-interactive-session.md) lets a reader walk that view without changing the evidence it records. Still open: the view the artifact level is judged in and what its graphic judgement records |
| 49 | [The review view's panel and the system it describes compete for one screen](#49-the-review-views-panel-and-the-system-it-describes-compete-for-one-screen) | Inconsistency | Cleared, [decision 0054](decisions/0054-the-review-panel-carries-the-summary-while-the-system-is-framed.md) |
| 50 | [A stored quantity carries no unit, no default, and no validation limit](#50-a-stored-quantity-carries-no-unit-no-default-and-no-validation-limit) | Foundational | Cleared, [decision 0060](decisions/0060-registry-revision-4-units-defaults-and-validation-limits.md), built as registry revision 4 in `dfac44c` |
| 51 | [The minimum landable radius decides a verdict from a code constant](#51-the-minimum-landable-radius-decides-a-verdict-from-a-code-constant) | Gap | Cleared, [decision 0059](decisions/0059-region-limits-are-a-pinned-record.md) |
| 52 | [Life is a structural absence, so the second tier can never be composed](#52-life-is-a-structural-absence-so-the-second-tier-can-never-be-composed) | Gap | **Open** |
| 53 | [A barycentre holds nothing, so a published pair contradicts its own masses](#53-a-barycentre-holds-nothing-so-a-published-pair-contradicts-its-own-masses) | Foundational | **Open**; its registry half is built — revision 4 declares the derived mass by `aggregate-sum/1` — and the pair is still placed without its mass ratio |
| 54 | [The registry, the grammars, and the numeric tables are code where the vocabulary is content](#54-the-registry-the-grammars-and-the-numeric-tables-are-code-where-the-vocabulary-is-content) | Inconsistency | **Open**, and its cost knowingly accepted: the owner took the surface ladder of [decision 0061](decisions/0061-surface-iterations-by-an-escalating-ladder-registry-revision-5-and-grammar-version-6.md) over settling this first, so four more rungs each fire the trigger |
| 55 | [Uniqueness is unguarded above the artifact](#55-uniqueness-is-unguarded-above-the-artifact) | Foundational | **Open** |
| 56 | [A starter destination grounds every admitted body, where decision 0044 gives its explorable planet one region](#56-a-starter-destination-grounds-every-admitted-body-where-decision-0044-gives-its-explorable-planet-one-region) | Inconsistency | Cleared, [decision 0071](decisions/0071-the-explorable-planet-is-the-subject-the-far-field-before-features-and-a-two-window-inspection.md) clause 3: the words are amended to the build, not the grammar to the words |
| 57 | [The explorable planet's type is drawn, but only rock and ocean can win it](#57-the-explorable-planets-type-is-drawn-but-only-rock-and-ocean-can-win-it) | Gap | **Open**, and unblocking: [decision 0071](decisions/0071-the-explorable-planet-is-the-subject-the-far-field-before-features-and-a-two-window-inspection.md) clause 2 accepts a sample with no icy ground rather than waiting for it |
...
**Status:** Cleared by [decision 0021](decisions/0021-sha256-stream-derivation.md), implemented as generator version 2 in `acdc063`, which derives both halves from the SHA-256 content hash of a `random-stream/2` record and deletes the mixer and its tests. The technical design, glossary, technology decision, and `src/README.md` no longer describe a pinned 64-bit mixer. Core carries an integer mixer again from 2026-09-10, the lattice hash inside `derive-surface-raster/1`, and this finding stays cleared rather than reopening: [decision 0056](decisions/0056-surface-raster-rule-and-the-boundary-of-stream-derivation.md) admits it as one rule's frozen internal arithmetic and not as a second hashing primitive, because every stream derivation and every record name is still SHA-256, the image it produces is seeded by a SHA-256 content hash, and nothing downstream of it is stored or content-addressed.
...
**Status:** Cleared 2026-09-07 by [decision 0041](decisions/0041-planet-fields-tangent-regions-minimum-radius-and-far-field.md), with the bound derived at 524,288 m. Applied to the technical design, development plan, and glossary.
...
**Status:** Cleared 2026-09-07 by [decision 0041](decisions/0041-planet-fields-tangent-regions-minimum-radius-and-far-field.md). Applied to the technical design, development plan, and glossary.
...
## Finding raised by the owner's generation note

Raised 2026-09-08 by comparing the owner's note "Environment generation and randomization" against the concept, requirements, development plan, technical design, glossary, accepted decisions, and registry revision 1. The note is owner intent on four topics: two destination levers, the composition of the destination system, explorable planets, and artifacts. About half of it restated what the documents already fix in more detail; the rest added requirements no document had or contradicted accepted decisions and the concept of record. It was clarified with the owner item by item and retired; its content survives in the context sections of decisions 0043 to 0046 and in the provenance of requirements R13 and R14.

### 42. The generation note diverges from the concept, plan, and accepted decisions

Affects: [concept 2](concept.md#2-destination-programming), [3](concept.md#3-the-destination-planetary-system), and [6](concept.md#6-the-artifacts); the scope, Navigation, Worlds, Exploration, and Content rows and the Destination validity and Gameplay/economy checks of the [development plan](development-plan.md#core-release-contents); [destination identity](technical-design.md#destination-identity-and-determinism), the [generation lifecycle](technical-design.md#generation-lifecycle), and [valuation](technical-design.md#artifact-valuation-and-transactions) in the technical design; the destination specification, distance tier, and artifact entries of the [glossary](glossary.md); and the orbit-connector cardinality of registry revision 1 ([decision 0042](decisions/0042-category-registry-revision-1-first-content-records-generator-and-publish-protocol.md)).

**Why it can go wrong.** Fifteen statements needed an owner answer before the note could become normative. The table shows the ones that contradict an accepted document; the remaining items were additions with no home, a text description at arrival, a close view of non-explorable planets, a size range and a fourth artifact kind, or terms the documents use differently: salt, sun, trip, environment.

| Topic | The note | The documents |
| --- | --- | --- |
| Distance | Continuous, 1 to 100 light years | Two snapping tiers, continuous distance at M3 ([decision 0012](decisions/0012-core-travel-model.md)) |
| Generation time | 5 minutes to a few hours | Seconds to minutes with a 60-second starter target; hours-long budgets at M3 ([decision 0004](decisions/0004-preparation-is-real-generation-time.md)) |
| Seed | A "salt" lever yielding a big integer or a set of integers | Salt is the campaign branch ([decision 0007](decisions/0007-artifact-collision-substitution-and-campaign-salt.md)); the seed is one 64-bit field ([decision 0021](decisions/0021-sha256-stream-derivation.md)); the plan promised recorded seeds and re-entry |
| Controls | Two levers | Distance, environment preferences, survey focus (concept 2) |
| Explorable planets | At least one, exactly one at the shortest trip; no life mentioned | At least two plus one life-bearing planet, enforced by the validity check (concept 3, plan) |
| Other planets | 1 to 30 | A star's orbit connector admits 0 to 16 children (registry revision 1) |
| Star | Exactly one sun of any type | Classes O to M plus a barycentre for binaries ([decision 0037](decisions/0037-derivation-rules-integer-periods-and-orbit-hierarchy.md), registry revision 1) |
| Explorability | By body type: gas, liquid, volcanic are out | By suit-profile validation plus the minimum radius (lifecycle step 4, [decision 0041](decisions/0041-planet-fields-tangent-regions-minimum-radius-and-far-field.md)) |
| Artifact families | Four | Three: mineral, biological, relic (plan, registry revision 1) |
| Artifact size | Bean to human height | Parts of 1 cm to 4 m, up to 8 attached (registry revision 1) |

Left as written, the note would have been indexed beside documents it contradicts, and the first world generator would have had two rules for the planet count, two for explorability, and two for what the seed is.

**Proposed solution.** Put every item to the owner as a question with the documents' current position and a recommended option, record the answers as decisions, apply them to every affected document, and retire the note rather than index it. Where the owner overrode the documents, the concept keeps the original idea inline and the decision records what was chosen, as [requirements](requirements.md) prescribes.

**Status:** Cleared 2026-09-08 by [decision 0043](decisions/0043-destination-controls-distance-tier-and-seed-lever.md) (distance, duration, the seed lever, and preferences), [decision 0044](decisions/0044-tiered-system-composition-one-star-and-explorability-by-validation.md) (one star, the tiered planet and life rule, explorability by validation, planet and region counts), [decision 0045](decisions/0045-close-views-only-in-the-surface-sky-and-a-derived-system-description.md) (close views only in the surface sky, the derived system description), and [decision 0046](decisions/0046-artifact-families-human-height-cap-cargo-by-mass-and-material-rarity.md) (three families, the human-height cap, cargo by mass and size class, material rarity). Applied to the concept, requirements, development plan, technical design, glossary, and progress.

## Findings raised by the composition generator

Raised 2026-09-08 while implementing step one of [decision 0047](decisions/0047-usable-storage-and-structure-generation-then-solar-system-iterations.md). The documents fix what a composition graph is, what a grammar decides, and what each transform type holds; these three questions had to be answered before the first graph could be composed, and none of them had an answer that could be read off an accepted document.

### 43. Connector tags do not say which side of an edge provides them

Affects: [connectors and constraints](technical-design.md#primitive-registry-and-composition) and [composition validation](technical-design.md#composition-validation) in the technical design; the connector declarations of registry revision 1 and of `content/templates/basic/vocabulary.json` ([decision 0042](decisions/0042-category-registry-revision-1-first-content-records-generator-and-publish-protocol.md)).

**Why it can go wrong.** [Decision 0031](decisions/0031-primitive-complete-composition-and-storage.md) makes typed connectors, not domain membership, the proof of compatibility, and each declaration carries provided and required tags. But a child attaches through its *parent's* connector, and the documents never say which of the child's own declarations the provided tags are read from. Three readings are defensible: the child's declaration for the like-labelled connector, the union of all its declarations, or a node-level tag set that no record has. They accept different children, so the choice changes every composed graph and is frozen into the recorded graph hash the moment one is recorded. The authored `basic` vocabulary made the gap concrete: its one artifact part provided `socket` and required `plug`, so under either reading no part could ever attach to another, and nothing had noticed because nothing composed.

**Proposed solution.** Put the three readings to the owner with the cost of each, take the answer as normative, and correct the authored vocabulary so its one part provides what it requires.

**Status:** Cleared 2026-09-08 by [decision 0048](decisions/0048-composition-grammar-version-1-graph-records-and-graph-publication.md): a connector label names a role, so a child is judged by its declaration for the like-labelled connector, and a category without that connector provides nothing. Applied to the composition generator, the graph record's validation, and the authored vocabulary.

### 44. A required child and the depth bound can contradict each other

Affects: the bounded-graph clauses of [decision 0031](decisions/0031-primitive-complete-composition-and-storage.md), the Destination validity check of the [development plan](development-plan.md#verification-and-performance-targets), and M0a exit criterion 8 in [progress](progress.md#m0a-exit-criteria).

**Why it can go wrong.** Graphs have versioned depth, node-count, and work limits, and retries are bounded and exhaustion reported. Nothing says what happens when a child is *required* and the bound leaves no room: registry revision 1 gives every planet exactly one atmosphere, and it also lets a planet carry moons, which are planets. A generator that places an optional moon at the depth limit then cannot give it its mandatory atmosphere, so a perfectly ordinary grammar fails at some seeds and not others. Left unanswered, the first generator would either have failed unpredictably, or quietly dropped a required child and produced a body with no atmosphere at all, which the primitive-completeness invariant forbids.

**Proposed solution.** Make the grammar state, from its own rules, the least depth and instance count each category costs with its required children; place an instance only where its whole required structure still fits; refuse at construction a grammar whose root cannot fit or whose required chain is cyclic; and fail explicitly, naming the instance path, when a required child cannot be placed.

**Status:** Cleared 2026-09-08 by [decision 0048](decisions/0048-composition-grammar-version-1-graph-records-and-graph-publication.md). Applied to the grammar record, the composition generator, and the depth bound of grammar version 1.

### 45. A transform's fields are fixed but nothing bounds their values

Affects: [decision 0036](decisions/0036-frames-and-transforms-typed-by-connector-kind.md), the [units, coordinates, and bounds](technical-design.md#units-coordinates-and-bounds) section, and the numeric-tables row of [decisions before production commitments](progress.md#decisions-before-production-commitments).

**Why it can go wrong.** Decision 0036 fixes the three transform types, their fields, and their widths, so a reader knows the bytes exactly. It says nothing about the range a generator draws a semi-major axis or an attachment offset from, and those are numeric content that measurement and play will change. Putting them in a definition would make every tuning change a new definition hash; putting them in the category registry would make it a new registry revision that every later pack pins. Both are the mistake [decision 0034](decisions/0034-storage-policy-pinned-by-manifests.md) already corrected for the storage policy.

**Proposed solution.** Declare the range per connector rule in the versioned composition grammar, pinned by its content hash, so tuning is a grammar version and no definition or registry revision moves.

**Status:** Cleared 2026-09-08 by [decision 0048](decisions/0048-composition-grammar-version-1-graph-records-and-graph-publication.md). Applied to the grammar record and grammar version 1.

## Findings raised by the first solar-system iteration

Raised 2026-09-08 while implementing and then running step two of [decision 0047](decisions/0047-usable-storage-and-structure-generation-then-solar-system-iterations.md). The first is what the describe command needed before it could decide anything; the second is what the first sample of twenty-four systems showed, and it is the first finding this review carries open.

### 46. The suit profile and the numeric tables have no home, no version, and no values

Affects: [decision 0044](decisions/0044-tiered-system-composition-one-star-and-explorability-by-validation.md), which makes explorability a validation outcome against "the suit profile's numeric limits"; the numeric-content row of [decisions before production commitments](progress.md#decisions-before-production-commitments); the Destination validity and Resource use checks of the [development plan](development-plan.md#verification-and-performance-targets).

**Why it can go wrong.** Eight documents refer to versioned numeric tables: suit envelopes, tier budgets, planet and region counts, effort scores, prices, material rarity weights, and the constants of the derivation rules. None of them says what a numeric table *is*: a record, a code file, authored content, a column in a manifest. Nor did any table have a value. The describe command of decision 0045 cannot decide a landing candidate without the suit profile's limits, so the first table had to exist before the first iteration could run, and inventing it inside the describe command would have put a tuning number where nothing pins it and no reproduction records it.

**Proposed solution.** Make a numeric table one canonical record identified by its content hash and versioned in its domain label, defined in code until an authoring tool needs it and moved to `content/` then, exactly as the category registry and the composition grammar are; have every artefact a table decides pin its version and hash. Put the suit profile's first values to the owner as a choice with the consequences of each.

**Status:** Cleared 2026-09-08 by [decision 0049](decisions/0049-suit-profile-and-system-description-version-1-and-derivation-rules-as-named-implementations.md), the owner choosing the suited-explorer envelope: a tenth to one and a half of standard gravity, up to two megapascals, and 120 K to 400 K. Applied to the suit profile record, the system description, and the iteration harness.

### 47. Nothing holds independently drawn parameters of one body physically consistent

Affects: [decision 0044](decisions/0044-tiered-system-composition-one-star-and-explorability-by-validation.md)'s clause that "the principles are physical consistency"; [decision 0037](decisions/0037-derivation-rules-integer-periods-and-orbit-hierarchy.md); the parameter schemas of `star` and `planet` in category registry revision 1 ([decision 0042](decisions/0042-category-registry-revision-1-first-content-records-generator-and-publish-protocol.md)); the Destination validity check of the [development plan](development-plan.md#verification-and-performance-targets).

**Why it can go wrong.** A category's parameters are drawn independently inside their template ranges, and no rule relates them. Decision 0037 supplies derivation rules that *compute* a dependent quantity, but a quantity that is also a stored parameter is never checked against them, and three pairs in registry revision 1 are related in nature and unrelated in the schema: a planet's mass and radius, which together fix its density; a star's spectral class and its effective temperature; and a star's luminosity against its radius and temperature. The first iteration's sample shows all three at once, and each is visible in the description the owner is asked to judge: a body of 3.12 Earth masses in a 1,380 km radius, whose density is four times that of osmium and whose surface gravity is 653 m/s^2; a star printed as class F at 9,628 K, which is class A's range; and two stars whose luminosity disagrees with `4 pi R^2 sigma T^4` by more than an order of magnitude. No amount of tuning the template ranges fixes this, because any independent draw of two related quantities can contradict itself.
...
**Status:** Cleared 2026-09-08 by [decision 0050](decisions/0050-registry-revision-2-grammar-version-2-and-versioned-record-growth.md), on the derivation path the owner's verdict on iteration 1 chose. Category registry revision 2 stores a mean density and no radius on a planet, and neither a spectral class nor a luminosity on a star, and declares each as a derived parameter naming the rule that computes it. Iteration 2's sample shows the effect: every one of its eight stars carries the class its temperature implies, where iteration 1's two carried classes that contradicted theirs ([progress](progress.md#solar-system-iterations)).

Two relatives of this finding survive it and are recorded with iteration 2 rather than reopened here, because they hold between bodies rather than inside one: a moon may outweigh the planet it orbits, and a body's type and its atmosphere are unrelated to the temperature and the gravity that would have to sustain them.

## Finding raised by the owner's note on judging the randomization levels graphically

Raised 2026-09-08, when the owner stated that the iteration loop of [decision 0047](decisions/0047-usable-storage-and-structure-generation-then-solar-system-iterations.md) step two is the pattern for the randomization levels that follow, explorable-planet generation and artifact generation, judged by graphic representations rather than by text, and that the solar-system level will need a graphic representation too.

### 48. Every randomization level is to be judged graphically, and nothing says which view, in what order, or against what vector

Affects: the order of the rest fixed by [decision 0047](decisions/0047-usable-storage-and-structure-generation-then-solar-system-iterations.md), which places the content-gate test plan, the minimal Godot viewer, and the content gate after its step two; [decision 0002](decisions/0002-primitive-set-content-gate.md), whose gate is the only review of rendered primitives the documents define; the close-views clause of [decision 0045](decisions/0045-close-views-only-in-the-surface-sky-and-a-derived-system-description.md), which admits no orbital view and places the planet-domain surface materials at M0b; M0a exit criteria 11 and 16 and the iteration record of [progress](progress.md#solar-system-iterations).

**Why it can go wrong.** The text description of [decision 0045](decisions/0045-close-views-only-in-the-surface-sky-and-a-derived-system-description.md) is the criterion of the solar-system iterations, and the owner states it is an interim one: every randomization level, that one included, is eventually judged by a graphic representation. No document records that intent, and four things it needs are missing, misordered, or already decided the other way.

First, the criterion: an iteration is defined by what judges it, so a rendered view is the criterion for those levels rather than later work, yet decision 0047 sequences both the minimal Godot viewer of M0a criterion 11 and the content-gate test plan of [decision 0002](decisions/0002-primitive-set-content-gate.md) after its step two.

Second, which view, and this is the part that touches an accepted decision. Decision 0045 confines other bodies to the surface sky and states that the core release adds no approach scene, no telescope or scanner zoom, and no orbital view. A graphic representation of a whole system is none of the views it admits. If the system graphic is an inspection tool for judging the generator, decision 0045 is untouched and the artifact and planet levels reuse the primitive renderer of decision 0002; if it is a view the player gets, it reverses that decision's close-views clause, which is a change only the owner can make.

Third, the content: registry revision 1 admits no surface material to the planet domain, which decision 0045 leaves to M0b, so a planet cannot be rendered to be judged until a registry revision adds those primitives; the artifact domain composes today only because its parts already carry geometry and material references.

Fourth, the record: decision 0047 requires every iteration to reproduce from its record, and decision 0045 makes a fixed-seed description a vector compared across Linux and Windows, but a rendered image is not bit-identical across drivers and renderers, so image bytes cannot serve as that vector, and a table row cannot carry the sample a verdict ruled on.

**Proposed solution.** Put the view question to the owner first, because the order depends on the answer: an inspection tool leaves decision 0045 standing and can be built beside the command-line tool, while a player-facing system view supersedes that decision's close-views clause and belongs in a record of its own. Then order the work by it, with decision 0002's gate reused as the review process for every graphic level rather than a second one being invented, and its test plan and the viewer moved ahead of the iterations they are the criterion for. Keep the determinism vector on the inputs, the graph and definition hashes an iteration already pins, and treat the image as evidence for the human verdict only, which is what decision 0002 already asks of a reviewer. State where a graphic iteration's sample is kept, since a verdict that cites images needs them held outside the row that records it. The registry revision admitting planet-domain surface materials is a prerequisite of the planet-level loop, and can be the same revision [finding 47](#47-nothing-holds-independently-drawn-parameters-of-one-body-physically-consistent) clears with.

**Status:** Open. No decision records the owner's intent yet; clearing it requires one that fixes which view each level is judged in, whether a system view changes the close-views clause of decision 0045, the order of the viewer and the gate against these iterations, and where a graphic iteration's sample is kept. Part of it is answered for the solar-system level by [decision 0052](decisions/0052-the-two-levers-compose-a-destination-and-a-review-view-shows-it.md), which builds a review view of a composed system beside its description and states that a review harness is not a core-release feature, so [decision 0045](decisions/0045-close-views-only-in-the-surface-sky-and-a-derived-system-description.md) is unchanged. The third part, that no registry revision admits a surface material to a body so a planet cannot be rendered to be judged, is answered by [decision 0055](decisions/0055-definition-level-tags-and-tagged-references.md): registry revision 3 gives a planet a `surface` reference, and definition-level tags are the mechanism that keeps the material it draws suited to the body, which is the wall a leaf category with no connector to declare on had put in the way. What stays open is the order of the levels, the view each of the other two is judged by, and what a graphic judgement records as its vector — all three of which [decision 0061](decisions/0061-surface-iterations-by-an-escalating-ladder-registry-revision-5-and-grammar-version-6.md) settles for the surface level, accepted on 2026-09-11: the surface level next and the artifact level after it, two review-harness frames rather than a player-facing view so decision 0045 still stands, the vector on the inputs with the pins named, and the sample kept outside the repository at a stated path. [Decision 0062](decisions/0062-the-surface-harness-walks-in-an-interactive-session.md) then lets a reader walk the walk frame in an interactive session, on the owner's request while he read the first cycle, and moves neither the frames a row cites nor the pins behind them. This finding is still not cleared, because it settles one level of the two: the artifact level's view and vector stay open whatever was decided for the surface.

## Finding raised by rendering the graphic sample

Raised 2026-09-10, taking the twenty-four pictures of iteration 3's starter destinations that the owner's reading of it is to be given ([progress](progress.md#solar-system-iterations)).

### 49. The review view's panel and the system it describes compete for one screen

Affects: [decision 0052](decisions/0052-the-two-levers-compose-a-destination-and-a-review-view-shows-it.md)'s clauses that the view shows the bodies "beside the description text they are judged by" and that "each body wears its own line of the same text the panel lists"; M0a exit criterion 11 of [progress](progress.md#m0a-exit-criteria).

**Why it can go wrong.** The panel prints a row for every body, a heading, the verdict, and the legend, in a monospace face as wide as the widest description row. On the sample's eight-planet systems that is 1,253 by 517 pixels of a 1600 by 900 window, 45 per cent of the screen, and the system is drawn behind it, so the inner bodies of the busiest systems fall inside the panel's own rectangle. A caption can be placed clear of the panel, and now is; a body cannot, because it is where the system puts it, and the larger the system the more of it the text covers. What the view does today is a compromise chosen while rendering the sample: the panel keeps a ground of its own at 55 per cent opacity, so its text is readable and the bodies behind it are visible but dimmed. No decision says which of the two owns the pixels.

**Proposed solution.** Divide the two by distance, as the captions already are. In the framed view the panel shows the heading, the totals, the verdict, and the legend alone, some ten rows, because every body's own line is already worn by the body; the whole table appears when the view is taken to a body, where only one line matters and the system is out of frame anyway. Add a key that hides and shows the panel, so a picture can be taken either way, and leave the ground opaque, since nothing then hides behind it. Both change what decision 0052 fixed, so they need the owner's word and a record of their own; a wider window is the alternative that changes no decision, and at 2560 by 1440 the same panel takes 18 per cent of the screen.

**Status:** Cleared 2026-09-10 by [decision 0054](decisions/0054-the-review-panel-carries-the-summary-while-the-system-is-framed.md), on the recommended path. The panel carries the summary alone while the whole system is framed and the whole table at a body, the captions and the panel divide the work by distance, and `p` or `--no-panel` hides it for a picture of the system alone. The sample was re-rendered in the framed form, where all sixteen bodies of its busiest system are visible; before it, seven of them were behind the panel's text.

## Findings raised by the solar-system storage audit

Raised 2026-09-10, on the owner's question of whether the primitive storage covers everything solar-system related: for a generated system, is every property held in a primitive definition, a composition graph, or another canonical record, or are there properties that exist only as code, only in a view, or nowhere at all, contrary to the primitive-completeness invariant of the [technical design](technical-design.md#primitive-registry-and-composition) and [concept 8](concept.md#8-randomness-from-expandable-primitives). The audit walked the chain — what registry revision 3 declares, what the `basic` vocabulary authors, what grammar version 4 composes, what a graph record stores, what the system description derives, what a destination pins, and what the review view draws — over the published set `aba608e6` at commit `3cff503`.

Most of the chain holds. Every parameter the description reads is a stored parameter or a derived one naming its rule; the appearance a body wears is content since [decision 0055](decisions/0055-definition-level-tags-and-tagged-references.md), and the last five properties the view invented were put on their stored values by [decision 0057](decisions/0057-the-view-draws-what-the-content-stores.md). What follows is what the walk found outside a record. Faults already carried as open, and therefore not repeated here, are the atmosphere unrelated to the gravity that would hold it and the albedo unrelated to the type and zone that would set it, both accepted open with iteration 3 ([progress](progress.md#solar-system-iterations)) and both named by [decision 0037](decisions/0037-derivation-rules-integer-periods-and-orbit-hierarchy.md)'s `derive-escape-velocity` and `derive-atmosphere-retention`; the six derivation rules decision 0037 lists that no consumer needs yet, `derive-orbital-period` among them, deferred by [decision 0049](decisions/0049-suit-profile-and-system-description-version-1-and-derivation-rules-as-named-implementations.md)'s rule that a rule is a named implementation before a category names it and by the Surface-sky consistency check standing at Not started; the stored-or-computed declaration of decision 0037, deferred by the same record; and the view's failure to say when it stands in, [inspection finding 5](inspection.md#5-the-view-does-not-say-when-it-is-standing-in).

### 50. A stored quantity carries no unit, no default, and no validation limit

Affects: [decision 0035](decisions/0035-category-registry-record-and-generator-revision-identifiers.md)'s clause that the registry records per category "the ordered parameter schema with each parameter's type, width, unit and scale, range, and default ... validation limits"; the `parameters` row of the [technical design](technical-design.md#primitive-registry-and-composition), which reads "Typed ranges, units, defaults, and bounded variation"; the [glossary](glossary.md#content-identity)'s primitive-category entry, which names validation limits; the Compatibility check of the [development plan](development-plan.md#verification-and-performance-targets).

**Why it can go wrong.** `ParameterDescriptor.Encode` in `src/SpaceExplorer.Core/Registry/ParameterDescriptor.cs` writes seven things: the label, the kind, the fraction bits, the minimum, the maximum, the enum labels, and the reference category. There is no unit, no default, and no validation limit, and `CategoryDefinition` carries no validation limit either. The fraction bits are a scale, not a unit: they say a `radius` is a fixed-point value with eight fraction bits, and nothing in the record says the whole is metres. What a stored quantity *means* therefore lives only in C#, and mostly in comments — a `mass` is in units of 10^20 kg, a `luminosity` in 10^20 W, a `surface-pressure` in pascals, an `effective-temperature` in kelvin, a `sidereal-period` in 20 Hz ticks, an `albedo` and a `roughness` in fractions of 65,535. Two of those units are written down as `const int MassUnitExponentKilograms = 20` and `const int LuminosityUnitExponentWatts = 20` in `CategoryRegistryRevision1`, and neither constant is referenced by any code in `src/` or `tests/`: they are documentation in the shape of a declaration, outside the record's bytes.

This defeats the guarantee decision 0035 exists to give. That decision's Consequences claim "a definition's bytes are decodable from its label alone plus a shipped data file"; they are decodable and not interpretable, because the shipped record does not say what the numbers are. Three concrete failures follow. A registry revision that changed a unit while keeping the range — mass in 10^21 kg, pressure in decapascals — would produce a record byte-identical in that field to the old one, so the hash that is supposed to make a reinterpretation impossible would not move. A reader outside this codebase, which is what a canonical content-addressed store is for, cannot render or check a stored definition at all. And a derivation rule's correctness rests on units that no record it pins declares: `derive-surface-gravity/1` folds `65536 x 10^8` into one multiplier because it assumes mass in 10^20 kg and radius in 1/256 m, and nothing the rule can read would tell it if a later revision changed either.

**Proposed solution.** Add the missing three to the parameter schema in a registry revision: a unit, as a short canonical text such as `kg/1e20`, `m`, `Pa`, `K`, `tick`, or `fraction/65535`, beside the existing fraction bits; a default; and the per-category validation limits decision 0035 and the glossary both name, or a record that strikes validation limits from both if the range and the derived parameters are now held to cover them. The revision costs what revision 3 cost — earlier revisions keep their bytes and every pack published under them keeps loading ([decision 0050](decisions/0050-registry-revision-2-grammar-version-2-and-versioned-record-growth.md)) — but only content published under the new revision gains units, so the value of doing it falls with every pack published without them. `MassUnitExponentKilograms` and `LuminosityUnitExponentWatts` then move from unreferenced constants into the record, or are trimmed under [decision 0024](decisions/0024-tests-comments-index-and-scaffolding-trimmed.md).

**Status:** **Cleared 2026-09-10**, on the rule that the finding clears when the revision is built and not when the record is accepted. The owner chose the fuller option — unit, default, and the per-category validation limits, rather than striking validation limits from decision 0035 and the glossary — and [decision 0060](decisions/0060-registry-revision-4-units-defaults-and-validation-limits.md) specified registry revision 4 precisely enough to build from. `dfac44c` builds it: every parameter restated with a unit and a decimal exponent beside the fraction bits, a default present exactly for the kinds that admit one, the decoder's seven bounds moved from C# constants into the record header with a per-category fan-out bound beside them, a full descriptor on every derived parameter so `spectral-class` keeps its labels in the record, and revisions 1 to 3 keeping their bytes and their hashes. One quantity decision 0060 had to decide rather than record, `artifact-part.mass` in grams, is itself the finding's evidence.

### 51. The minimum landable radius decides a verdict from a code constant

Affects: [decision 0041](decisions/0041-planet-fields-tangent-regions-minimum-radius-and-far-field.md), which fixes the 524,288 m minimum; [decision 0049](decisions/0049-suit-profile-and-system-description-version-1-and-derivation-rules-as-named-implementations.md)'s rule that a numeric table is a canonical record every artefact it decides pins; [decision 0053](decisions/0053-a-destination-is-a-stored-record-addressed-by-its-levers.md)'s destination specification; the Destination validity check of the [development plan](development-plan.md#verification-and-performance-targets).

**Why it can go wrong.** A landing candidate is decided by four numbers: the suit profile's gravity, pressure, and temperature limits, and the minimum landable radius. Three of them are a versioned canonical record whose version and hash every destination pins, precisely so a stored "pass" can be re-checked against the limits that gave it. The fourth is `public const long MinimumLandableRadius = 524_288L << PlanetFractionBits` in `CategoryRegistryRevision1`, and `SystemDescription.Describe` refuses a body on it before it consults the suit profile at all. The constant is not a category parameter, so it is not in the registry record's canonical bytes; it is not in the suit profile; it is in nothing a destination pins. Changing it silently reinterprets every stored destination's verdict, and the destination record cannot tell that it has changed — which is exactly the failure the suit profile's hash prevents for the other three, and exactly the failure the tier rules are being given a record of their own to prevent.

The value is also the one landing limit that is not a suit limit at all: decision 0041 derives it from the geometry of a maximal region on a sphere, so it belongs with the region rules rather than with what a suit resists, and it will be joined by the region rules themselves when regions exist and the landing-candidate flag becomes the validation outcome decision 0044 asks for.

**Proposed solution.** Either add the minimum radius to the suit profile as `suit-profile/2`, on the ground that it is one of the four numbers one verdict reads, or give it a numeric table of its own beside the suit profile, on the ground that it is a region-geometry limit rather than a suit limit and will grow region rules around it; the second is the better fit for what comes next, and the choice is the owner's. Either way the destination specification pins its version and hash beside the suit profile's, and the description prints it in the same `pinned` line, which is what makes a verdict re-checkable. Doing it now costs one version bump and the reissue of destinations that are disposable iteration output; doing it after the core release reissues published worlds.

**Status:** Cleared 2026-09-10 by [decision 0059](decisions/0059-region-limits-are-a-pinned-record.md), on the recommended option the owner chose: a numeric table of its own rather than a second version of the suit profile, because the value says what a body's shape allows and not what a person survives, and decision 0044's region rules will grow there. The description prints it and is therefore version 3, which moved its frozen vector; the destination pins it, which moved every destination pack for the second time that day. [Decision 0058](decisions/0058-tier-rules-are-a-pinned-record.md) had taken the same fix one input over and said in terms that it did not clear this one.

### 52. Life is a structural absence, so the second tier can never be composed

Affects: [decision 0044](decisions/0044-tiered-system-composition-one-star-and-explorability-by-validation.md)'s per-tier life rule; [decision 0043](decisions/0043-destination-controls-distance-tier-and-seed-lever.md)'s distance-tier lever; the totals of [decision 0045](decisions/0045-close-views-only-in-the-surface-sky-and-a-derived-system-description.md)'s system description; the M0b row and the Destination validity check of [progress](progress.md#milestones).

**Why it can go wrong.** No category registry revision defines a life category. `SystemDescription.Derive` looks one up by label and gets null, so `LifeBearing` is false on every body of every system and `LifeBearingCount` is zero by construction, not by generation. The description then prints `no life` as though it had counted something. The tier rules demand at least one life-bearing body above the starter tier, so the demand can never be met, and the bounded retry of [decision 0052](decisions/0052-the-two-levers-compose-a-destination-and-a-review-view-shows-it.md) exhausts all 64 attempts:

```
$ ... destination --tier second --seed 7 --set aba608e6bb0302a184d2c82ebdda526c --no-publish
error: No system of the second tier came out of seed 7 within 64 attempts; the last failed because
the second tier has at least 2 explorable planets; this system has 0; the second tier has at least
1 life-bearing body; this system has 0.
$ echo $?
1
```

Two things are wrong rather than merely unbuilt. One of the two destination levers of decision 0043 accepts a value that cannot produce a destination on any seed, and nothing — not the command's usage, not the M0b row, not decision 0044 — says so; a reader of the documents would expect `--tier second` to work, and all 48 published destinations are `starter` because it does not. And a property the description reports and a rule turns on originates in a missing category rather than in a primitive, which is the primitive-completeness invariant's own failure case: the invariant asks that every property come from an exact primitive revision, its parameters, or an overlay, and "no life" today comes from a `TryFindByLabel` returning null. Decision 0044's Consequences say life primitives "appear only from the second tier ... which M1 includes", which is about when a player reaches the tier, not about when the category exists; nothing records that the tier is uncomposable until it does.

**Proposed solution.** Two parts, and only the second waits on content. Record the state: a line in the M0b row of [progress](progress.md#milestones) saying that the second tier cannot be composed under registry revision 3 because no revision defines a life category, and a usage note on the `destination` and `iterate` commands in [tools.md](tools.md#dotnet). Then, when the life-form domain gets its vocabulary and grammar, add the life category in the registry revision that carries it, so the flag counts a primitive; the description's wording and the tier profile need not change, because both already read a count.

**Status:** Open, with the first part applied. The M0b row of [progress](progress.md#milestones) and the `dotnet` section of [tools](tools.md#dotnet) now record that the second tier cannot be composed under registry revision 3 and why, which is [decision 0011](decisions/0011-requirements-single-source.md)'s single-source rule applied and not a clearing. The category itself waits on the registry revision that carries the life-form domain.

### 53. A barycentre holds nothing, so a published pair contradicts its own masses

Affects: [decision 0037](decisions/0037-derivation-rules-integer-periods-and-orbit-hierarchy.md)'s clause that an orbit connector's parent may be "an explicit `barycentre` primitive, which is non-rendered and whose mass is the aggregated sum of its children's"; the `barycentre` category of registry revisions 1 to 3; the barycentre production of [grammar version 3](decisions/0051-grammar-version-3-orbits-scaled-to-the-star-and-bodies-suited-to-their-zone.md); [decision 0036](decisions/0036-frames-and-transforms-typed-by-connector-kind.md)'s system inertial frame; [decision 0044](decisions/0044-tiered-system-composition-one-star-and-explorability-by-validation.md), which keeps the category in the core release.

**Why it can go wrong.** The `barycentre` category declares zero parameters in every registry revision and no derived parameter, so decision 0037's clause that its mass is the aggregated sum of its children's is written in a record nowhere: no aggregation-rule primitive exists, the registry declares no `mass` for it, and `SystemDescription` gives it mass, radius, gravity, and temperature of zero and calls it "a point, not a body". The grammar then draws the pair as two unrelated orbits. `CompositionGrammarVersion3`'s barycentre production gives its two children one range for the semi-major axis, 100,000,000 to 2,000,000,000 m, with no spacing ratio and no band, so each companion draws its own axis, its own eccentricity, its own inclination and its own mean anomaly independently of the other.

A two-body pair about a common centre of mass has none of that freedom: the two semi-major axes are in the inverse ratio of the masses, the two periods are equal, the two eccentricities are equal, the two orbits are coplanar, and the mean anomalies differ by half a turn. Nothing holds any of the five. Seed 17 of the `basic` set shows what that produces — a barycentre at 0.062 AU whose two companions are a rocky body of 0.01 Earth masses and a gas giant of 1,493, a ratio near 150,000 to 1, so the point they are drawn about should lie deep inside the giant while the record places both at comparable distances from it. Twenty-three of the sample's first sixty seeds carry at least one barycentre, so this is live generated content and not a future concern.

Two smaller consequences of the same emptiness. Because a barycentre has no mass, the pair's period could not be derived even when `derive-orbital-period/1` arrives, which is the one place in the tree where the deferral of that rule is blocked by a missing record rather than by a missing implementation. And decision 0036 defines the system inertial frame by the root's spin axis and prime meridian "at the epoch" while admitting a barycentre as that root; a barycentre stores neither, and neither does a `star`, so the frame's definition names two properties no record holds. The second matters only when propagation exists; the first and the geometry matter now.

**Proposed solution.** Give the barycentre the mass decision 0037 already says it has, as a derived parameter aggregating its children — which is the first use of an aggregation-rule primitive and needs a registry revision — and then place the pair from it in a grammar version: draw one relative orbit for the pair and split it by the mass ratio, or draw one companion's axis and derive the other's, so that the two axes, periods, eccentricities and anti-phase follow from one record instead of four independent draws. This is [finding 47](#47-nothing-holds-independently-drawn-parameters-of-one-body-physically-consistent)'s fault on an edge rather than inside a node, and it takes the same remedy, deriving what follows rather than drawing it. The alternative, which is cheaper and worse, is to bound the pair's masses by connector tags so the ratio stays near one; that hides the contradiction rather than removing it. The cheap moment is now, while the content that carries barycentres is disposable iteration output; the fix moves both the registry revision and the grammar version, and therefore the bytes of every graph that holds a barycentre.

**Status:** Open, with its registry half built and carried with the sample it was found in: it is recorded as iteration 3's fourth fault in [progress](progress.md#solar-system-iterations), beside the atmosphere and the albedo, and marked there as found after the owner's acceptance rather than before it. [Decision 0060](decisions/0060-registry-revision-4-units-defaults-and-validation-limits.md) gives the `barycentre` the derived mass decision 0037 already says it has, aggregating its children by the first aggregation-rule primitive, and states that placing the pair by that ratio is grammar version 5's work; the finding clears when both land. `dfac44c` builds the registry half: revision 4 declares `barycentre.mass` derived by `aggregate-sum/1` in units of 10^20 kg. Version 5 as built is version 3's rules unchanged over revision 4, so the two companions still draw their semi-major axes, eccentricities and mean anomalies independently.

### 54. The registry, the grammars, and the numeric tables are code where the vocabulary is content

Affects: [decision 0035](decisions/0035-category-registry-record-and-generator-revision-identifiers.md)'s clause that the category registry "is authored data under `content/`"; [content/README.md](../content/README.md), which lists the registry record and the numeric tables among what `content/` holds; [decision 0048](decisions/0048-composition-grammar-version-1-graph-records-and-graph-publication.md) and [decision 0049](decisions/0049-suit-profile-and-system-description-version-1-and-derivation-rules-as-named-implementations.md), which each say "defined in code until an authoring tool needs it"; [decision 0002](decisions/0002-primitive-set-content-gate.md)'s rule that authored content enters as templates and constraints.

**Why it can go wrong.** Four authored inputs decide what a generated system is: the category registry, the composition grammar, the template vocabulary, and the numeric tables. One of them is data — `content/templates/basic/vocabulary.json`, editable and reloadable without a build. The other three are C#: three registry revisions, four grammar versions, and `SuitProfile.Version1`, with a fourth kind of table arriving as `TierProfile`. The documents do not agree about this. Decision 0035 states flatly that the registry "is authored data under `content/`", and `content/README.md` lists "the category registry record" and "numeric tables such as tier budgets and effort scores" among the things that directory holds; neither is there. Decisions 0048 and 0049 say instead "defined in code until an authoring tool needs it", and the class comment on `CategoryRegistryRevision1` names the trigger for the move as "a second revision or an authoring tool" — a condition that has now fired three times without the move.

The practical cost is that the two halves of one generation are tuned under different rules: widening a template's mass range is a file edit and a rerun, while widening the registry's mass range, changing a band's zone tag, or retuning a suit limit is a rebuild, which the iteration loop of [decision 0047](decisions/0047-usable-storage-and-structure-generation-then-solar-system-iterations.md) does on every turn. The documentary cost is worse: a reader following decision 0035 to `content/` finds nothing, and a decision that says where a thing lives is wrong about where it lives.

**Proposed solution.** Settle it once, in one record, rather than per artefact. The recommended position is that the canonical record is the authority and its *source form* is a tool concern for all four alike, as decisions 0048 and 0049 already word it — so amend the divergence in the other direction: a record superseding the "authored data under `content/`" clause of decision 0035, `content/README.md` corrected to say the registry and the numeric tables are minted from code today, and one stated trigger for moving all four source forms to `content/`, which is an authoring or a tuning tool and not a revision count. The alternative, moving the registry, the grammars and the tables to JSON now, gains the tuning loop but adds three parsers and three more ways to publish a record whose hash is already frozen, for content the iterations rewrite in code anyway. Whichever is chosen, the class comment's trigger goes with it, since it is the one that has silently expired.

**Status:** Open, and the owner has chosen to keep paying it. Asked on 2026-09-11 whether to settle this before the surface level, he took the escalating ladder of [decision 0061](decisions/0061-surface-iterations-by-an-escalating-ladder-registry-revision-5-and-grammar-version-6.md) instead; four of its seven rungs add a registry revision or a grammar version, so the trigger named above fires four more times, each rung being a rebuild where a vocabulary change is a file edit and a rerun. That record states the cost in its Consequences and clears nothing of this finding. Rung 2 was the first of the four: [decision 0063](decisions/0063-relief-by-terrain-heightfield-registry-revision-6-and-grammar-version-7.md), accepted and built, adds registry revision 6 and grammar version 7, and names the same cost again in its own Consequences rather than pretending otherwise. It does note one partial offset: relief's three tunable parameters — amplitude, roughness, wavelength — are content in the authored vocabulary, so what an owner is likeliest to retune after reading a sample is the half that is already a file edit.

## Finding raised by the storage assessment

Raised 2026-09-10, reading the primitive and graph structure against what a planet surface will ask of it — the assessment recorded in [primitives part 5](primitives.md#part-5-what-the-structure-does-not-yet-carry). Most of what that reading found is growth the documents already name and [progress](progress.md) already tracks as unbuilt. One thing is neither: a promise the concept makes that no structure keeps.

### 55. Uniqueness is unguarded above the artifact

Affects: [decision 0007](decisions/0007-artifact-collision-substitution-and-campaign-salt.md), whose comparison and substitution are defined over artifacts alone; [concept 7](concept.md#7-the-players-goal)'s clause that "uniqueness should be visible as well as recorded"; the [glossary](glossary.md#worlds-and-destinations)'s appearance recipe, which is an artifact's; the Artifact variety check of the [development plan](development-plan.md#verification-and-performance-targets); [decision 0043](decisions/0043-destination-controls-distance-tier-and-seed-lever.md)'s seed lever, which promises a fresh destination per pull.

**Why it can go wrong.** The design guards uniqueness in exactly one place. [Decision 0007](decisions/0007-artifact-collision-substitution-and-campaign-salt.md) canonicalizes an artifact's appearance recipe, buckets its continuous parameters so near-identical recipes compare equal, compares each new artifact against the whole campaign, and re-samples on a collision from a salted variation stream. Every other mechanism the documents name keeps that scope: the silhouette comparison of [decision 0002](decisions/0002-primitive-set-content-gate.md) is a duplicate detector for generated primitives, and the Artifact variety check reviews artifact samples. Nothing compares one system with another, or one planet with another.

Below that, the generator's only rule is byte-identity within one set: `SetGenerator` keeps a `HashSet<ContentHash>` and retries a template whose draw repeats a definition it has already accepted, failing by name when the retry budget is exhausted. That guarantees no two definitions in a pack are the same bytes. It says nothing about two definitions being indistinguishable to a player, and nothing at all about two *compositions* of the same definitions.

The consequence is already recorded, in two halves that take different fixes.

*Structural.* A destination is addressed by the hash of its specification ([decision 0053](decisions/0053-a-destination-is-a-stored-record-addressed-by-its-levers.md)), so two lever pairs always differ in identity; identity is not similarity, and nothing compares the graphs behind them. The 48 destinations on the workstation at the time of this reading drew 658 instances from 81 distinct definitions (`tools/stats.cs`, 2026-09-10) — reuse is the design working as intended, since decision 0053 makes a system small precisely because the variety lives in the shared set. What is missing is the check that says when reuse has become repetition.

*Content thinness.* Iteration 4's reading already records the visible symptom — repeated body definitions within one system and four ice materials a player cannot tell apart ([progress](progress.md#solar-system-iterations)) — and names its cause correctly as a vocabulary matter, fixed by authoring rather than by structure. The structural gap is that nothing would have told anyone: the sample was read by eye, on twenty-four pictures, by the owner.

Concept 7 says a discovery should feel new and that renaming does not make it so. Between that promise and byte-identity within one pack there is no mechanism at all.

**Proposed solution.** Extend the mechanism that exists rather than inventing a second one. Decision 0007 already has the shape: a canonical recipe with continuous parameters bucketed, compared within a scope, with an explicit action on collision. Three questions decide how it generalizes, and they are the owner's: what the scope is for a system, since an artifact's is the campaign and a destination's could be the campaign or nothing; what a system's recipe excludes, since two systems that differ only in orbital phase are the same discovery and two that differ in body count are not; and what a collision does, since re-sampling a destination means drawing another attempt in the retry [decision 0052](decisions/0052-the-two-levers-compose-a-destination-and-a-review-view-shows-it.md) already runs, which is cheap, whereas re-sampling a planet inside an accepted system is not. A cheaper first step, and the one to take if the answer is not obvious: make the repetition *visible* rather than corrected, by reporting distinct-definition counts per system and per sample in the iteration harness, so an iteration's verdict is given on a number as well as on pictures. `tools/stats.cs` already computes most of it.

Do not fold this into the content gate of [decision 0002](decisions/0002-primitive-set-content-gate.md). That gate reviews rendered primitives for distinctness and is the right instrument for the thinness half; it is a review process over a fixed sample, not a rule the generator applies, and the structural half needs a rule.

**Status:** Open. Clearing it takes a record fixing the scope, the recipe, and the collision action for a system, or an explicit decision that a system needs no such guard and the seed lever's near-unique value is enough. The cheaper first step this finding recommends — visible counts rather than a correcting rule — is what the surface iterations table already applies at rung 1 (regions per destination, distinct surface materials) and what [decision 0063](decisions/0063-relief-by-terrain-heightfield-registry-revision-6-and-grammar-version-7.md) added at rung 2, distinct relief fields across the sample. [Decision 0070](decisions/0070-a-biome-is-a-derived-set-registry-revision-9-and-grammar-version-10.md) applies it once more at rung 3, counting distinct biome elements across the sample and biomes actually present per region — the second because a palette of six that paints one is a repetition a picture might not show. [Decision 0071](decisions/0071-the-explorable-planet-is-the-subject-the-far-field-before-features-and-a-two-window-inspection.md) clause 7 adds one more of the same kind and says why it is cheap now: with the sample narrowed to each destination's one explorable planet, the count worth printing is how many distinct planet definitions those twenty-four grounds come from. None of them counts a system against another system, so none clears this finding; all are the same recommended step applied one rung further.

## Findings raised before the fourth surface rung

Raised 2026-09-12, checking the owner's six statements of that day against the accepted records and against the build — the statements [decision 0071](decisions/0071-the-explorable-planet-is-the-subject-the-far-field-before-features-and-a-two-window-inspection.md) records. Both are things the documents and the code disagreed about; neither was created by that record. The owner's rulings of the same day clear the first and leave the second open on purpose.

### 56. A starter destination grounds every admitted body, where decision 0044 gives its explorable planet one region

Affects: [decision 0044](decisions/0044-tiered-system-composition-one-star-and-explorability-by-validation.md)'s region clause; [decision 0061](decisions/0061-surface-iterations-by-an-escalating-ladder-registry-revision-5-and-grammar-version-6.md) clause 3, which says cycle one generates "one `region` node under the destination's landing-candidate planet"; grammar version 6 and every version since, which place one region per admitted body; [decision 0067](decisions/0067-a-destinations-ground-is-generated-when-it-is-composed.md), which grounds all of them; the surface sample, which has been read on them.

**Why it can go wrong.** [Decision 0044](decisions/0044-tiered-system-composition-one-star-and-explorability-by-validation.md) states that "the starter tier's explorable planet has one landing region", and [decision 0061](decisions/0061-surface-iterations-by-an-escalating-ladder-registry-revision-5-and-grammar-version-6.md) clause 3 repeats the singular. What the grammar builds is one region on every body `admit-landable-body/1` admits — large enough by [region limits version 1](decisions/0059-region-limits-are-a-pinned-record.md) and declaring `solid-surface` — which is a mean of 4.6 regions to a destination and 120 over the twenty-four seeds of cycle four ([progress](progress.md#surface-iterations)). Most of that ground is on bodies the suit refuses: over the twenty-four starter destinations of set pack `e5565984`, measured on 2026-09-12, each has exactly one explorable planet and the sample carries 37 landable moons beside them, while the regions outnumber even those.

Three costs follow, and only the third is serious. A destination's ground is 4.5 MiB where one region would be 1.0 MiB, which [decision 0068](decisions/0068-campaign-storage-budget-re-derived-from-the-payload-ceiling.md)'s 640 MiB budget absorbs without noticing. A reader's frames land on ground nobody can stand on — cycle one recorded four of its six doing so and left the question to the owner. And an accepted record says something the build does not do, so the next reader must guess which is authoritative, which is exactly what [decision 0011](decisions/0011-requirements-single-source.md) exists to prevent.

**Proposed solution.** Choose once and apply the choice to whichever side is wrong: keep what is built and amend the words — a region is ground, and a landing region is ground a suit survives, so every admitted body gets one and the explorable planet's is decision 0044's — or narrow the grammar, which costs a grammar version and a re-mint of every destination's ground for a saving no budget needs.

**Status:** Cleared, [decision 0071](decisions/0071-the-explorable-planet-is-the-subject-the-far-field-before-features-and-a-two-window-inspection.md) clause 3, on the owner's ruling of 2026-09-12 that the words are amended and the grammar left alone. The amendment is worded in that clause, and applied to the [development plan](development-plan.md#core-release-contents)'s Worlds row and the [glossary](glossary.md#worlds-and-destinations)'s region entry, which were the two places that restated the singular.

### 57. The explorable planet's type is drawn, but only rock and ocean can win it

Affects: [decision 0044](decisions/0044-tiered-system-composition-one-star-and-explorability-by-validation.md), whose explorability clause says the body type "shifts the odds through template ranges and never decides"; [decision 0051](decisions/0051-grammar-version-3-orbits-scaled-to-the-star-and-bodies-suited-to-their-zone.md)'s zone bands; the `basic` vocabulary's body templates; [decision 0070](decisions/0070-a-biome-is-a-derived-set-registry-revision-9-and-grammar-version-10.md)'s per-kind palettes, of which the icy ones are authored for ground no player reaches.

**Why it can go wrong.** Nothing selects which planet is explorable: every body is drawn under its zone's tags and the suit profile decides, so the type is as random as the draw. The outcome is not. Over the twenty-four starter destinations of set pack `e5565984`, measured on 2026-09-12, the explorable planets are **18 rocky and 6 ocean and none icy**, and all 37 landable moons beside them are rocky. An icy body takes a cold band by [decision 0051](decisions/0051-grammar-version-3-orbits-scaled-to-the-star-and-bodies-suited-to-their-zone.md)'s rule that a body suits the orbit it takes, and is then refused by temperature and by gravity together — seed 8's icy planet is `no: gravity temperature` at 68 K and 0.86 m/s², 65 AU out.

So decision 0044's promise that type never decides is true of the mechanism and false of the distribution, and two records rest on the wider one: [decision 0070](decisions/0070-a-biome-is-a-derived-set-registry-revision-9-and-grammar-version-10.md) authors icy palettes, and [decision 0070](decisions/0070-a-biome-is-a-derived-set-registry-revision-9-and-grammar-version-10.md) clause 12 spends a third of the sample's frames showing icy ground, which is ground the core release cannot land on. A reader has been judging a kind of world the game does not currently offer.

**Proposed solution.** It is content's to fix, not the grammar's or the harness's, which is the half of [finding 54](#54-the-registry-the-grammars-and-the-numeric-tables-are-code-where-the-vocabulary-is-content)'s cost that is a file edit. Either the `basic` vocabulary authors an icy body that a suit survives — massive enough for the gravity floor, in a band cold enough to be icy and warm enough to pass — or the suit profile admits a colder one, which is a second version of a pinned record and moves every destination's identity ([decision 0049](decisions/0049-suit-profile-and-system-description-version-1-and-derivation-rules-as-named-implementations.md)). The vocabulary is the cheaper of the two and the one to try first. Until then a sample read on the explorable planet is a sample of rock and ocean, which [decision 0071](decisions/0071-the-explorable-planet-is-the-subject-the-far-field-before-features-and-a-two-window-inspection.md) clause 2 chooses to make visible rather than to compensate for.

**Status:** Open, and deliberately not a condition of anything. [Decision 0071](decisions/0071-the-explorable-planet-is-the-subject-the-far-field-before-features-and-a-two-window-inspection.md) clause 8 names it and answers none of it, and its clause 2 accepts a cycle whose sample carries no icy ground rather than holding the rung until this is fixed. Clearing it takes a vocabulary that authors an icy body a suit survives, or a second suit-profile version, and the first is the cheaper.
