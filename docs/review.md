...
| 48 | [Every randomization level is to be judged graphically, and nothing says which view, in what order, or against what vector](#48-every-randomization-level-is-to-be-judged-graphically-and-nothing-says-which-view-in-what-order-or-against-what-vector) | Gap | **Open**; the owner's intent is unrecorded. Partly answered, as the body records: [decision 0052](decisions/0052-the-two-levers-compose-a-destination-and-a-review-view-shows-it.md) makes the system view a review harness and not a core-release feature, so the close-views clause of [decision 0045](decisions/0045-close-views-only-in-the-surface-sky-and-a-derived-system-description.md) stands, and [decision 0055](decisions/0055-definition-level-tags-and-tagged-references.md) supplies the third part's prerequisite, a registry revision that admits a surface material to a body. Still open: the order of the levels, the view each of the other two is judged in, and what a graphic judgement records as its vector, which [decision 0061](decisions/0061-surface-iterations-by-an-escalating-ladder-registry-revision-5-and-grammar-version-6.md) proposes to settle for the surface level and leaves open for the artifact level |
