...
| 49 | [The review view's panel and the system it describes compete for one screen](#49-the-review-views-panel-and-the-system-it-describes-compete-for-one-screen) | Inconsistency | **Open**; which of the two owns the pixels is the owner's to fix, and the 55 per cent ground the sample was rendered with is a compromise, not a rule |
...
**Status:** Open. Raised while rendering the twenty-four-picture sample, which was taken with the 55 per cent ground and is legible; clearing it requires a decision on what the panel shows in the framed view and whether a key hides it.
