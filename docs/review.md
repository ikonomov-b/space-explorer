...
**Status:** Open. Clearing it takes a record fixing the scope, the recipe, and the collision action for a system, or an explicit decision that a system needs no such guard and the seed lever's near-unique value is enough.
