...
public sealed class CompositionGrammars
{
    ...
    public static CompositionGrammars Supported { get; } = Of(CompositionGrammarVersion1.Grammar, CompositionGrammarVersion2.Grammar, CompositionGrammarVersion3.Grammar, CompositionGrammarVersion4.Grammar, CompositionGrammarVersion5.Grammar);
